  ...
  return (
    <div className='footer'>
      ...
      <div className="social-login-icons">
        <div className="socialcontainer">
          <a href="https://www.linkedin.com/in/shivank-gupta-064a83314" target="_blank" rel="noopener noreferrer">
            <div className="icon social-icon-1-1">
              ...
              >
                <path
                  d="M100.28 448H7.4V148.9h92.88zm-46.44-341a53.59 53.59 0 1 1 53.58-53.6 53.61 53.61 0 0 1-53.58 53.6zM447.9 448h-92.4V302.4c0-34.7-12.4-58.4-43.4-58.4-23.7 0-37.8 16-44 31.4-2.3 5.5-2.8 13.1-2.8 20.8V448h-92.5s1.2-270.8 0-298.1h92.4v42.2c-.2.3-.5.7-.7 1h.7v-1c12.3-19 34.3-46 83.5-46 60.9 0 106.6 39.8 106.6 125.2V448z"
                ></path>
              </svg>
            </div>
          </a>
        ...
        <div className="socialcontainer">
          <a href="https://www.instagram.com/shiv_ank_gupta/" target="_blank" rel="noopener noreferrer">
